			...
			foreach($modelColumn2 as $label => $value) {
				...
				$pdf->SetFillColor(205,201,201);
					...
					$pdf->GetY());
                                    ...
                                    $pdf->MultiCell(5+$headerColumnWidth-$offsetX, 7, $label, 1, 'L', 1, 1, $headerFrame->x+$headerColumnWidth+5, 
                                                $pdf->GetY()+$offsetY+13); 

                                    $pdf->SetFont('aealarabiya', ''); 
                                    $pdf->MultiCell(5+$headerColumnWidth-$offsetX, 7, $value, 1, 'L', 0, 1, $headerFrame->x+$headerColumnWidth+5,  
                                                $pdf->GetY()); 
                                    } 
                                } 
                            } 
